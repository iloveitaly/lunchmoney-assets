        ...
        if "kbb.com" in asset_metadata["url"]:
            ...
            if "mileageStart" in asset_metadata and "mileageDate" in asset_metadata:
                ...
                mileage_date = datetime.strptime(
                    asset_metadata["mileageDate"], "%Y-%m-%d"
                )
            ...
            svg_path = extract_text_from_xpath(
                browser, asset_metadata["url"], "//object/@data"
            )
            if svg_path:
            ...
            zillow_price = extract_text_from_xpath(
                browser, asset_metadata["url"], zillow_xpath
            )
            if not zillow_price:
            ...
            if "redfin" in asset_metadata:
                ...
                redfin_price = extract_text_from_xpath(
                    browser, asset_metadata["redfin"], redfin_xpath
                )
                if redfin_price:
                    ...
                    print(
                        f"Could not find Redfin home value for {asset_metadata['redfin']}"
                    )
